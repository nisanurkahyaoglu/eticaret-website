...
try {
    ...
    $sorgu = $db->query("SELECT * FROM users order by eposta");
     ...
     <div class="navbar">
         <div class="dropdown">
             ...
             <div class="dropdown-content">
                ...
                <a href="logout.php"><i class="fa-solid fa-right-from-bracket" style="color: #000000;"></i>Çıkış Yap</a>
             </div>
          </div> 
            ...
            <li class="catmenu-link1">
                ...
                <div class="menu1">
                    <ul>
                           ...
                           <li><a href="mancat.html" class="menu-ıtem" title="Erkek Giyim">
                           ...
                           <li><a href="shoe-bagcat.html" class="menu-ıtem" title="Ayakkabı&Çanta">
     ...
     <div class="form-section">
         ...
         <form class="user-info">
              <div class="top">
                   <div class="name">
                       <label>Ad</label><br>
                       <input type="text" autocomplete="off" name="isim" value="<?php echo $cikti['isim']; ?>">
                   </div>
                   <div class="sname">
                       <label>Soyad</label><br>
                       <input type="text" autocomplete="off" name="soyisim" value="<?php echo $cikti['soyisim'];?>">
                    </div>
              </div> 
              ...
              <div class="middle">
                <div class="email">
                    ...
                    <input type="text" autocomplete="off" name="eposta" value="<?php echo $cikti['eposta'];?>">
                </div>
              </div>
        ...
        <div class="update-pass" >
            ...
            <form class="user-pass" action="changepass.php" method="post">
                     <div class="old-pass">
                         <label>Şu Anki Şifre</label><br>
                         <input type="password" autocomplete="off" name="msifre" id="msifre">
                     </div>
                     <div class="new-pass">
                         <label>Yeni Şifre</label><br>
                         <input type="password" autocomplete="off" name="ysifre" id="ysifre"><br>
                         <p>Şifreniz <b>en az 7 karakter</b> ve <b>en fazla 64 karakter</b> olmalı, harf ve rakam içermelidir.</p>
                      </div> 
  
                <div class="middle-pass">
                  <div class="again">
                      <label>Yeni Şifre (Tekrar)</label><br>
                      <input type="password" autocomplete="off" name="tsifre" id="tsifre">
                  </div>
                </div>
                <button type="submit" name="submit" id="submit" value="güncelle">GÜNCELLE</button>
