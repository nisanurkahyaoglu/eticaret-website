...
<head>
    ...
    <link rel="stylesheet" href="adresstyle.css">
        ...
        <form class="form">
          ...
          <div class="second">
           ...
           <div class="third">
              <div class="ilçe">
                    <label>İlçe</label>
                    <input type="text" name="ilçe"  value="">
               </div>

               <div class="mahalle">
                   <label>Mahalle</label>
                   <input type="text" name="mahalle"  value="">
               </div>
           </div>
