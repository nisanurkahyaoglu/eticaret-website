...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="womanstyle.css">
        ...
        <div class="row">
                ...
                <div class="col-md-3">
                   <form action="" method="GET">
                        ...
                        <button type="submit" href="kidcat.php" class="btn-primary">Temizle</button>
                ...
                <div class="col-md-9 mt-3">
                    <form action="kidcat.php?action=add=id="></form>
                   <div class="card">
                                ...
                                <?php
                                    if(isset($_GET['cats'])){
                                        ...
                                        foreach($catchecked as $rowbrand){
                                                ...
                                                $prod = "SELECT * FROM products3 WHERE size_id IN ($rowbrand)" ;
                                        ...
                                        foreach($catchecked as $rowbrand){
                                               ...
                                               $pro = "SELECT * FROM products3 WHERE price_id IN ($rowbrand)" ;
                                        ...
                                        foreach($check as $rowbrand){
                                               ...
                                               $prot = "SELECT * FROM products3 WHERE size_id,price_id IN ($rowbrand) " ;
