...
<head>
    ...
    <link rel="stylesheet" href="shoe-bag.css">
    <title>Ayakkabı & Çanta</title>
</head>
<body>
        ...
        <div class="row">
                ...
                <div class="col-md-3">
                   <form action="" method="GET">
                        ...
                        <button type="submit" href="shoe-bagcat.php" class="btn-primary">Temizle</button>
                ...
                <div class="col-md-9 mt-3">
                    <form action="shoe-bagcat.php?action=add=id="></form>
                   <div class="card">
                                ...
                                <?php
                                    if(isset($_GET['cats'])){
                                        ...
                                        foreach($catchecked as $rowbrand){
                                                ...
                                                $prod = "SELECT * FROM products4 WHERE size_id IN ($rowbrand)" ;
                                        ...
                                        foreach($catchecked as $rowbrand){
                                               ...
                                               $pro = "SELECT * FROM products4 WHERE price_id IN ($rowbrand)" ;
                                        ...
                                        foreach($check as $rowbrand){
                                               ...
                                               $prot = "SELECT * FROM products4 WHERE size_id,price_id IN ($rowbrand) " ;
