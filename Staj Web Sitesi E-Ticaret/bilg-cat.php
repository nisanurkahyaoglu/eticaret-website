                                ...
                                <?php
                                    if(isset($_GET['cats'])){
                                        ...
                                        foreach($catchecked as $rowbrand){
                                                ...
                                                $prod = "SELECT * FROM products7 WHERE brand_id IN ($rowbrand)" ;
                                        ...
                                        foreach($catchecked as $rowbrand){
                                               ...
                                               $pro = "SELECT * FROM products7 WHERE price_id IN ($rowbrand)" ;
                                        ...
                                        foreach($check as $rowbrand){
                                               ...
                                               $prot = "SELECT * FROM products7 WHERE brand_id,price_id IN ($rowbrand) " ;
