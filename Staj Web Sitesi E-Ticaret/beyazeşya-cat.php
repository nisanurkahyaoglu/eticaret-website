...
<head>
    ...
    <link rel="stylesheet" href="bilg-style.css">
        ...
        <div class="row">
                ...
                <div class="col-md-3">
                   <form action="" method="GET">
                        ...
                        <button type="submit" href="bilg-cat.php" class="btn-primary">Temizle</button>
                ...
                <div class="col-md-9 mt-3">
                    <form action="bilg-cat.php?action=add=id="></form>
                   <div class="card">
                                ...
                                <?php
                                    if(isset($_GET['cats'])){
                                        ...
                                        foreach($catchecked as $rowbrand){
                                                ...
                                                $prod = "SELECT * FROM products8 WHERE brand_id IN ($rowbrand)" ;
                                        ...
                                        foreach($catchecked as $rowbrand){
                                               ...
                                               $pro = "SELECT * FROM products8 WHERE price_id IN ($rowbrand)" ;
                                        ...
                                        foreach($check as $rowbrand){
                                               ...
                                               $prot = "SELECT * FROM products8 WHERE brand_id,price_id IN ($rowbrand) " ;
