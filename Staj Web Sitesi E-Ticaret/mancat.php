        ...
        <div class="row">
                ...
                <div class="col-md-3">
                   <form action="" method="GET">
                        ...
                        <button type="submit" href="mancat.php" class="btn-primary">Temizle</button>
                ...
                <div class="col-md-9 mt-3">
                    <form action="mancat.php?action=add=id="></form>
                   <div class="card">
                                ...
                                <?php
                                    if(isset($_GET['cats'])){
                                        ...
                                        foreach($catchecked as $rowbrand){
                                                ...
                                                $prod = "SELECT * FROM products2 WHERE size_id IN ($rowbrand)" ;
                                        ...
                                        foreach($catchecked as $rowbrand){
                                               ...
                                               $pro = "SELECT * FROM products2 WHERE price_id IN ($rowbrand)" ;
                                        ...
                                        foreach($check as $rowbrand){
                                               ...
                                               $prot = "SELECT * FROM products2 WHERE size_id,price_id IN ($rowbrand) " ;
